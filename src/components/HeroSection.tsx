...
import profileImage from '../lib/Bolarinwa.jpg'; 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6" ref={contentRef}>
            ...
            <div className="flex items-center gap-4 pt-4">
              <a href="https://github.com/quadribola91" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-primary dark:text-gray-400 dark:hover:text-primary transition-colors">
                <Github size={24} />
                <span className="sr-only">GitHub</span>
              </a>
              <a href="https://www.linkedin.com/in/omobolarinwa-quadri-a207b3216/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-primary dark:text-gray-400 dark:hover:text-primary transition-colors">
                <Linkedin size={24} />
                <span className="sr-only">LinkedIn</span>
              </a>
              <a href="mailto:quadribola91@gmail.com" className="text-gray-600 hover:text-primary dark:text-gray-400 dark:hover:text-primary transition-colors">
                <Mail size={24} />
          ...
          <div className="hidden md:flex justify-center" ref={imageRef}>
            <div className="relative w-72 h-72 lg:w-96 lg:h-96">
              ...
              <Avatar className="w-64 h-64 lg:w-80 lg:h-80 rounded-full overflow-hidden border-4 border-white dark:border-gray-700 shadow-lg">
                  <AvatarImage 
                    src={profileImage}
                    alt="Profile"
