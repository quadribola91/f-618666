      ...
      <div className="container mx-auto px-6">
        <div className="mb-16 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Have a project in mind or need IT support? Feel free to reach out to me.
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full mt-1 p-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary bg-transparent min-h-[150px]"
                  required
                ></textarea>
              </div>
